...
async function startFx(
  ...
  const active = await TmuxSession.create({
    ...
    env: {
      ...
      ...(gateway
        ? {
          ANTHROPIC_API_KEY: "fake-input-navigation-key",
...
tmuxTest.skip(
  ...
  async () => {
    ...
    const active = await TmuxSession.create({
      ...
      env: {
        HOME: testHome,
        ANTHROPIC_API_KEY: "fake-image-input-key",
        ANTHROPIC_BASE_URL: localGateway.baseUrl,
        GROK_CLI_CHAT_PROXY_BASE_URL: `${localGateway.baseUrl}/v1`,
...
tmuxTest.skip(
  ...
  async () => {
    ...
    const active = await TmuxSession.create({
      ...
      env: {
        HOME: testHome,
        ANTHROPIC_API_KEY: "fake-repeated-image-key",
        ANTHROPIC_BASE_URL: localGateway.baseUrl,
        GROK_CLI_CHAT_PROXY_BASE_URL: `${localGateway.baseUrl}/v1`,
        FX_MODEL: FAKE_GATEWAY_MODEL,
        FX_AUTO_UPGRADE: "0",
...
tmuxTest.skip(
  ...
  async () => {
    ...
    const active = await TmuxSession.create({
      ...
      env: {
        HOME: testHome,
        ANTHROPIC_API_KEY: "fake-image-id-key",
        ANTHROPIC_BASE_URL: localGateway.baseUrl,
        GROK_CLI_CHAT_PROXY_BASE_URL: `${localGateway.baseUrl}/v1`,
        FX_MODEL: FAKE_GATEWAY_MODEL,
        FX_AUTO_UPGRADE: "0",
...
tmuxTest.skip(
  ...
  async () => {
    ...
    const active = await TmuxSession.create({
      ...
      env: {
        HOME: testHome,
        ANTHROPIC_API_KEY: "fake-image-yank-key",
        ANTHROPIC_BASE_URL: localGateway.baseUrl,
        GROK_CLI_CHAT_PROXY_BASE_URL: `${localGateway.baseUrl}/v1`,
        FX_MODEL: FAKE_GATEWAY_MODEL,
        FX_AUTO_UPGRADE: "0",
...
tmuxTest(
  ...
  async () => {
    ...
    const active = await TmuxSession.create({
      ...
      env: {
        HOME: testHome,
        ANTHROPIC_API_KEY: "fake-pending-image-key",
        ANTHROPIC_BASE_URL: localGateway.baseUrl,
        GROK_CLI_CHAT_PROXY_BASE_URL: `${localGateway.baseUrl}/v1`,
        FX_MODEL: FAKE_GATEWAY_MODEL,
        FX_AUTO_UPGRADE: "0",
...
tmuxTest(
  ...
  async () => {
    ...
    const active = await TmuxSession.create({
      ...
      env: {
        HOME: testHome,
        ANTHROPIC_API_KEY: "fake-input-appearance-key",
        ANTHROPIC_BASE_URL: localGateway.baseUrl,
        GROK_CLI_CHAT_PROXY_BASE_URL: `${localGateway.baseUrl}/v1`,
        FX_MODEL: SUPERGROK_MODEL,
        FX_AUTO_UPGRADE: "0",
